...
-- measurement
-- \i custom/bg.sql
\i custom/blood_differential.sql
\i custom/cardiac_marker.sql
-- \i custom/chemistry.sql
-- \i custom/coagulation.sql
\i custom/complete_blood_count.sql
\i measurement/creatinine_baseline.sql
-- \i custom/enzyme.sql
-- \i measurement/gcs.sql
-- \i measurement/height.sql
-- \i measurement/icp.sql
-- \i custom/inflammation.sql
